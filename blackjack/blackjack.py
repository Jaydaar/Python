...
def deal_player():
    # score calculations moved to its own function
    # global player_score
    # global player_ace
...
# Insert card frame creation here
...
new_button = tkinter.Button(button_frame, text="New Game", command=start_new_game)
