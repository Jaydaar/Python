    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album object to add to the list.
                If the album is already present, it will not add again (although this is yet to be implemented).
        """
    ...
    with open("album.txt", "r") as albums:
        for line in albums:
            ...
            if new_artist is None:
                ...
                # otherwise create a new artist object and add it to the artist list.abs
